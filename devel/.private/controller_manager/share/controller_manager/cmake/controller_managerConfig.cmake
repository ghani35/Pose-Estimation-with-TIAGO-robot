...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/ghani/tiago_public_ws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/ghani/tiago_public_ws/devel/.private/controller_manager)
  ...
  set(controller_manager_INSTALL_PREFIX /home/ghani/tiago_public_ws/install)
...
if(NOT "/home/ghani/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/ghani/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ghani/tiago_public_ws/src/ros_control/controller_manager/${idir}'.  ${_report}")
    endif()
    _list_append_unique(controller_manager_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "controller_manager;/usr/lib/x86_64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ghani/tiago_public_ws/devel/.private/controller_manager/lib;/home/ghani/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
